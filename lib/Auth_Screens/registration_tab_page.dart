...
import 'package:green_sellers/widgets/custom_text_field.dart';
import 'package:green_sellers/widgets/loading_dialog.dart';
      ...
      if (passwordTextEditingController.text ==
        ...
        if (nameTextEditingController.text.isNotEmpty &&
          ...
          fStorage.Reference storageRef = fStorage.FirebaseStorage.instance
              .ref()
              .child("sellersImages")
              .child(nameTextEditingController.text.trim())
              .child(fileName);
              ...
              child: Column(
                children: [
                  ...
                  CustomTextField(
                    ...
                    hintText: "Enterprise Email Address",
                    isObsecre: false,
                    enabled: true,
                  ),
                  ...
                  CustomTextField(
                    ...
                    iconData: Icons.lock,
                    hintText: "Enterprise Operational Address",
                    isObsecre: false,
                    enabled: true,
                  ),
